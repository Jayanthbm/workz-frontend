            ...
            <span className={styles.counryUsers}>
              {this.props.managers.onlineStatus === "offline" && (
                ...
                >
                  ...
                  {this.props.i % 2 < 1 && (
                    <span>
                      <ProfileStatus left={0} leftSide={true} offline={true} />
              ...
              {this.props.managers.onlineStatus === "active" && (
                ...
                >
                  {this.props.i % 2 > 0 && (
                    <span>
                      <ProfileStatus right={0} active={true} rightSide={true} />
                  ...
                  {this.props.i % 2 < 1 && (
                    <span>
                      <ProfileStatus left={0} active={true} leftSide={true} />
              ...
              {this.props.managers.onlineStatus === "passive" && (
                ...
                >
                  ...
                  {this.props.i % 2 < 1 && (
                    <span>
                      <ProfileStatus left={0} passive={true} leftSide={true} />
                      <img className={styles.abc} src={leftonline} />
                      <div className={styles.onlineleft}></div>
                    </span>
                  )}
